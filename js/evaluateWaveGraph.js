let lpfWaveCanvas = document.getElementById('dmWaveCanvas');
...
const vertical_scale_element = document.getElementById("eval_vertical_scale_factor");
const horizontal_scale_element = document.getElementById("eval_horizontal_scale_factor");
let delta_element = document.getElementById("Delta");
let wave_frequency_element = document.getElementById("swfrequency");
let wave_amplitude_element = document.getElementById("Am");
let sampling_frequency = document.getElementById("safrequency");
let wave_amplitude = document.getElementById("swamplitude");
let wave_frequency = document.getElementById("swfrequency");
let delta = 2 * Math.PI * wave_amplitude.value * wave_frequency.value / sampling_frequency.value;

//try
let wave_amp_op=document.getElementById("Am");
let wave_freq_op=document.getElementById("Fm");
...
export function drawEvaluateWave() {
    ...
    wave_amp_op.innerText = wave_amplitude.value*2 + ' V';
    wave_freq_op.innerText = wave_frequency.value + ' Hz';
    ...
    plotSine(lpfWaveCtx, wave_amplitude.value, wave_frequency.value, orgx, mid_of_line, vertical_scaling_factor, horizontal_scaling_factor,mid_of_line);
    requestAnimationFrame(drawEvaluateWave);
}